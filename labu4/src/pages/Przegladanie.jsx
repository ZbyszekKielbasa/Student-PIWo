                ...
                <ul className="nav-links">
                    ...
                    {showModal && (
                        <Modal onClose={toggleModal}>
                            ...
                            <button className="button primary" onClick={() => registerWithEmailPassword(email, password, navigate)}>Register</button>
                            <button className="button primary" onClick={() => loginWithEmailPassword(email, password, navigate)}>Login with Email</button>
                            <button className="button primary" onClick={() => login(navigate)}>Login with Google</button>
                        </Modal>
                    )}
